...
#ifndef MESSAGE_H
#define MESSAGE_H
enum MessageType {Ping, Auth, StatusReply, ImageListReply, ImageReply, Ack, NegAck, StatusRequest, ImageListRequest, ViewsRequest, DenyReqeust, ImageRequest, ViewsReply}; 
...
class Message
{
    ...
    public:
        ...
        int getID();
        MessageType getType();
    	bool setImageData(string path);
    	bool setTextData(Data &d);
