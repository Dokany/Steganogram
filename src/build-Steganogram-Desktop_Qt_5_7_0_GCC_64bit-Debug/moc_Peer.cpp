...
QT_MOC_LITERAL(4, 35, 11) // "countWindow"

    },
    "Peer\0terminateProgram\0\0firstWindow\0"
    "countWindow"
};
...
void Peer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Peer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Peer::countWindow)) {
                *result = 2;
                return;
            }
        }
